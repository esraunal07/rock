...
export default async function admin() {
  if (await checkLogIn()) {
    window.location.href = "#login";
    return ""; // Bu satırı ekleyerek, kullanıcı giriş yapmamışsa boş bir içerik döndürüyoruz.
  }
...
async function checkLogIn() {
  try {
    ...
    return true; // Hata durumunda varsayılan olarak kullanıcıyı çıkış yapmış olarak kabul ediyoruz.
  }
}
